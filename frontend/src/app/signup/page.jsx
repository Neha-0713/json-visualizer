...
import * as Yup from 'yup';
 ...
 const SignupSchema = Yup.object().shape({
   ...
   password: Yup.string().required('required').matches(/[a-z]/,("must include lowercase")).matches(/[A-Z]/,("must include uppercase")).matches(/[0-9]/,('must contain a number')).matches(/\W/,('must contain special characters')),
...
const Signup = () => {
  ...
  const signupForm= useFormik({
    ...
    onSubmit:(values, {resetForm})=>{
      ...
      axios
      .post("http://localhost:5000/realstate/add", values)
      .then((response) => {
