...
const manageProperty = () => {
    ...
    const deleteProperty = (id) => {
        axios.delete('http://localhost:5000/realstate/delete/' + id)
            .then((response) => {
    ...
    const displayProperty = () => {
        return(
        <table className="min-w-full divide-y bg-[#F6ECE3] divide-gray-200 dark:divide-neutral-700 mt-10">
    <thead className=" bg-[#91766E]  dark:bg-neutral-800">
        <tr>
                        ...
                        propertyList.map(property => {
                            return (
                                <tr key={property._id} >
                                    ...
                                    <td className="size-px whitespace-nowrap">
                                        <div className="px-6 py-1.5">
                                            <Link
                                                ...
                                                href={"/updateProperty/"+property._id}
                                            >
                                                Edit
                                            </Link>
                                        </div>
                                    ...
                                    <td className="size-px whitespace-nowrap">
                                        <div className="px-6 py-1.5">
                                            <button onClick={() => { deleteProperty(property._id) }} className="text-sm text-white font-medium bg-red-600 rounded-lg px-3 py-1">
                                                Delete
                                            </button>
                                        </div>
                                    </td>
  ...
  return (
    ...
    <h1 className='text-center font-bold text-3xl mt-10'>Manage Property</h1>
    {displayProperty()}
</div>
  )
}
