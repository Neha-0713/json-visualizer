...
const home = () => {
  return (
    ...
    <div className='bg-[#F6ECE3]'>
      ...
      <>
        {/* ========== HEADER ========== */}
        <header className="sticky top-4 inset-x-0 before:absolute before:inset-0 before:max-w-[66rem] before:mx-2 before:lg:mx-auto before:rounded-[26px] before:border before:border-[#997d75] dark:border-neutral-700 after:absolute after:inset-0 after:-z-[1] after:max-w-[66rem] after:mx-2 after:lg:mx-auto after:rounded-[26px] after:bg-[#dec6bf] dark:bg-neutral-900 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
    ...
    <div className='h-[100vh]'>
      ...
      <div className='align-bottom'>
        <footer className="bg-[#c6a9a0] align-text-bottom max-h-2:">
          <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
            <div className="text-center">
              ...
              <a
                href="#"
                className="mt-8 inline-block rounded-full border border-gray-900 px-12 py-3 text-sm font-medium text-white hover:bg-orange-50 hover:text-black focus:outline-none focus:ring active:bg-indigo-500"
              >
                Get Started
              </a>
            </div>
